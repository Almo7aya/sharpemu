...
/// pthread_cond_wait or sceKernelWaitSema) call this between wait slices:
/// a thread parked there never reaches the import-boundary safe point where
/// queued exceptions are normally consumed, so IL2CPP's stop-the-world
/// suspension would deadlock waiting for its acknowledgement.
/// </summary>
